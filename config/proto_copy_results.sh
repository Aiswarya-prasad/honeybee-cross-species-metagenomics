...
mkdir -p fastqc
mkdir -p fastqc/raw
fastqc/raw/*_*_fastqc.html
mkdir -p fastqc/trim
fastqc/trim/*_*_trim_fastqc.html
mkdir -p 02_HostMapping
...
do
  mkdir -p 06_MAG_binning/backmapping/${sample}
...
do
  mkdir -p 07_AnnotationAndPhylogenies
  mkdir -p 07_AnnotationAndPhylogenies/02_orthofinder
  mkdir -p 07_AnnotationAndPhylogenies/02_orthofinder/${group}/OrthoFinder/
  mkdir -p 07_AnnotationAndPhylogenies/02_orthofinder/${group}/OrthoFinder/Results_${group}
  mkdir -p 07_AnnotationAndPhylogenies/02_orthofinder/${group}/OrthoFinder/Results_${group}/Comparative_Genomics_Statistics
  mkdir -p 07_AnnotationAndPhylogenies/02_orthofinder/${group}/OrthoFinder/Results_${group}/Orthogroups
  mkdir -p 07_AnnotationAndPhylogenies/05_IQTree/
  mkdir -p 07_AnnotationAndPhylogenies/05_IQTree/${group}/
...
mkdir -p 09_MagDatabaseProfiling
mkdir -p 09_MagDatabaseProfiling/MAGsDatabaseMapping
...
mkdir -p database
mkdir -p database/MAGs_database_Orthofinder
...
mkdir -p 09_MagDatabaseProfiling/
mkdir -p 09_MagDatabaseProfiling/CoverageEstimation
mkdir -p 09_MagDatabaseProfiling/CoverageEstimation/Merged
