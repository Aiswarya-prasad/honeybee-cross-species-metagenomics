...
with open(cluster_out, 'a+') as out_fh:
    ...
    if already_processed == 0:
        header_line = "\t".join(['cluster', 'num_genes', 'num_hosts', 'hosts', 'M', 'C', 'D', 'F', 'A', 'mean_length', 'standard_deviation', 'min_length', 'max_length', 'length_representative', 'representative_gene'])
