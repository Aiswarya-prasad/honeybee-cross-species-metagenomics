...
combined_info_df <- vis_magOTUs_df_all %>%
                      mutate(Cluster = paste0(Genus, "_", magOTU))
...
system('mkdir -p results/figures/07-Orthogroup_heatmaps')
for (genus_iter in genera) {
  my_upper_count <- 20
  pdf(paste0("results/figures/07-Orthogroup_heatmaps/", genus_iter, "_OG_counts.pdf"))
