...
get_genecount_matrix <- function(my_genus, scps_only = F, upper_count = 10, combined_info = combined_info_df, mags_info = vis_magOTUs_df, only_mags = F, with_isolates = T) {
  ...
  if (with_isolates & !only_mags) {
    OG_numbers_df <- read.csv(paste0("11_phylogenies/02_orthofinder_results", my_genus, "/OrthoFinder/Results_", my_genus, "/Orthogroups/Orthogroups.GeneCount.tsv"), sep = "\t")
...
Groups = genera_list
for (group in Groups) {
  OG_numbers_df <- read.csv(paste0("11_phylogenies/02_orthofinder_results", group, "/OrthoFinder/Results_", group, "/Orthogroups/Orthogroups.GeneCount.tsv"), sep = "\t")
