...
# save.image("/...<project_dir_path>.../20230313_apis_species_comparison/results/figures/workspace_generaldata_chunks_20230611.RData")
load("/...<project_dir_path>.../20230313_apis_species_comparison/results/figures/workspace_generaldata_chunks_20230611.RData")
source("/...<project_dir_path>.../20230313_apis_species_comparison/scripts/visualization/utilitites.R")
```
...
# system("bash scripts/calc_genome_sizes.sh /...<project_dir_path>.../20230313_apis_species_comparison/results/09_MAGs_collection/MAGs_high_medium /...<project_dir_path>.../20230313_apis_species_comparison/results/figures/Genome_sizes_good_quality.csv fa")
# system("bash scripts/calc_genome_sizes.sh /...<project_dir_path>.../20230313_apis_species_comparison/results/09_MAGs_collection/MAGs /...<project_dir_path>.../20230313_apis_species_comparison/results/figures/Genome_sizes.csv fa")
# system("bash scripts/calc_genome_sizes.sh /...<project_dir_path>.../20230313_apis_species_comparison/results/11_phylogenies/downloads /...<project_dir_path>.../20230313_apis_species_comparison/results/figures/Genome_sizes_refs.csv fna")
...
host_tree_path <- "/...<project_dir_path>.../20230313_apis_species_comparison/data/host_tree_published.tree"
...
vis_magOTUs_df %>%
  ...
  mutate(mag_path = paste0("/...<project_dir_path>.../20230313_apis_species_comparison/results/09_MAGs_collection/MAGs/", ID, ".fa")) %>%
  ...
  mutate(anno_path_faa = paste0("/...<project_dir_path>.../20230313_apis_species_comparison/results/07_MAG_binng_QC/03_checkm_results/", Sample, "/bins/", ID_mod, "/genes.faa")) %>%
  mutate(out_path_faa = paste0("results/export/MAGs_annotation_faa/", new_mag_name, ".fa")) %>%
  mutate(anno_path_gff = paste0("/...<project_dir_path>.../20230313_apis_species_comparison/results/07_MAG_binng_QC/03_checkm_results/", Sample, "/bins/", ID_mod, "/genes.gff")) %>%
