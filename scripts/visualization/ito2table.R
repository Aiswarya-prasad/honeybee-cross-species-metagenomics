...
file = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_family-info.tsv"
outdir_created = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_family-info"
system(paste0("mkdir -p ", outdir_created))
create_itol_files(file, identifier = "id", label = "Label",
    background = "", identifier2 = "", directory = outdir_created, colour.file = "",
    gradient.file = "", separator = "\t", na.strings = paste0(c("", "(null)",
      "NA"), collapse = separator), quote = "\"", abort = FALSE,
    conversion = "none", double.to.bars = FALSE, emblems = "", template = "%s",
    max.size = 20L, favour = 1, width = 0.5, precision = 1L, restrict = "",
...
file = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_order-info.tsv"
outdir_created = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_order-info"
system(paste0("mkdir -p ", outdir_created))
create_itol_files(file, identifier = "id", label = "Label",
    background = "", identifier2 = "", directory = outdir_created, colour.file = "",
    gradient.file = "", separator = "\t", na.strings = paste0(c("", "(null)",
...
file = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/MAG_information_formatted.csv"
outdir_created = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_user-info"
system(paste0("mkdir -p ", outdir_created))
create_itol_files(file, identifier = "ID", label = "Label",
    background = "", identifier2 = "", directory = outdir_created, colour.file = "",
    gradient.file = "", separator = ",", na.strings = paste0(c("", "(null)",
...
file = "/work/FAC/FBM/DMF/pengel/spirit/aprasad/BACKUP_current/20230313_apis_species_comparison/results/09_MAGs_collection/MAGs_metadata_summary.tsv"
# file = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/MAG_information_formatted.csv"
outdir_created = "/nas/FAC/FBM/DMF/pengel/spirit/D2c/aprasad/20211018_aprasad_ApisCrossSpeciesAnalysis/EditedFigures/20230313_trees/gtdb_tree/20230313_MAGs_user-info"
# system(paste0("rm -rf ", outdir_created))
system(paste0("mkdir -p ", outdir_created))
create_itol_files(file, identifier = "ID", label = "Label",
    background = "", identifier2 = "", directory = outdir_created, colour.file = "",
    gradient.file = "", separator = "\t", na.strings = paste0(c("", "(null)",
