...
There are a total of 200 samples. 150 (5 species * 6 colonies * 5 individual bees = 150 samples) from Malaysia and 50 (5 individuals * [1 colony (mellifera) + 3 colonies * 3 species(cerana, dorsata, florea)] = 50 samples) from India.
  ...
  geom_hline(yintercept = 6.5, linetype = "solid") +
   ...
   geom_hline(yintercept = 30.5, linetype = "solid") +
    ...
    geom_vline(xintercept = 10, linetype = "solid", color = "#d73027", alpha = 1) +
      ...
      ggsave("results/figures/00a-DNA_Concentrations_compared.pdf")
```
  ...
  geom_hline(yintercept = 6.5, linetype = "solid") +
   ...
   geom_hline(yintercept = 30.5, linetype = "solid") +
    ...
    geom_vline(xintercept = 10, linetype = "solid", color = "#1a9850", alpha = 1) +
      scale_fill_manual(values=host_order_color) +
      scale_color_manual(values=host_order_color_dark)
      ggsave("results/figures/00a-DNA_Concentrations.pdf")
```