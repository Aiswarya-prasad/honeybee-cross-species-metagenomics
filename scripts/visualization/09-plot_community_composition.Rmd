...
```{r instrain_plots_breadth_vs_num_reads_unfiltered}
plot_breadth_num_reads <- ggplot(instrain_breadth_depth_unfiltered %>% mutate(breadth = breadth*100),
                             aes(x = sample,
                                 y = filtered_read_pair_count,
                                 size = breadth,
                                 color = Host
...
paginate_save(plot_breadth_num_reads, "magOTU", "results/figures/10-instrain_plots/2-mapped_reads_by_magOTU_unfiltered.pdf", pass_nrow = 3, pass_ncol = 3)
```
```{r plot_genus_composition_num}
samples_chosen <- samples_IN
df_to_plot <- df_reads_plot %>%
                filter(Sample %in% samples_chosen & Type %in% c("MAGs_DB", "Unmapped_mags")) %>%
...
ggplot() +
  geom_bar(data = df_to_plot,
           aes(y=factor(Sample, levels = samples_chosen),
               x=Number,
               fill = factor(Type, levels = c("Unmapped_mags", "MAGs_DB"))
  ...
  scale_fill_manual(values=c("Unmapped" = brewer.pal(9, "Pastel1")[1],
    ...
    make_theme(theme_name=theme_few(), leg_pos="bottom",
      ...
      scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
    ggsave("results/figures/09-Genus_composition_by_instrain_mapping_num_with_total_reads.pdf")
```
...
ggplot() +
  ...
  labs(x = "Sample",
       ...
       fill = "Type") +
  scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6)) +
  scale_fill_manual(values=c("Unmapped_mags" = brewer.pal(9, "Pastel1")[1],
                             "MAGs_DB" = brewer.pal(9, "Pastel1")[3],
                             "Host_mapped" = brewer.pal(9, "Pastel1")[2]
                            ),
                    labels=c("Unmapped_mags",
                             "Mapped to MAGs",
                             "Mapped to Host"
                            )
                   ) +
...
plot_genus_proportions <- ggplot() +
  ...
  make_theme(theme_name=theme_few(), leg_pos="bottom",
    ...
    ggsave("results/figures/09-Genus_composition_by_instrain_mapping_proportion.pdf")

ggplotly(plot_genus_proportions)
# library(pandoc) - install and re run later
saveWidget(
                widget = ggplotly(plot_genus_proportions),
                file = "results/figures/09-Genus_composition_by_instrain_mapping_proportion.html",
...
plot_genus_num_corrected <- ggplot() +
  ...
  make_theme(theme_name=theme_few(), leg_pos="bottom",
                                        ...
                                        #  max_colors = length(unique(plot_mapping_df_by_magotu$Genus)),
                                         x_angle=45 ,x_vj=1.2, x_hj=1, x_size=12,
                                         y_angle=0 ,y_vj=0, y_hj=0, y_size=12)
    ggsave("results/figures/09-Genus_composition_by_instrain_mapping_num_corrected.pdf")
ggplotly(plot_genus_num_corrected)
saveWidget(
                widget = ggplotly(plot_genus_num_corrected),
                file = "results/figures/09-Genus_composition_by_instrain_mapping_num_corrected.html",
...
plot_genus_perc_corrected <- ggplot() +
  ...
  make_theme(theme_name=theme_few(), leg_pos="bottom",
                                         ...
                                         y_angle=0 ,y_vj=0, y_hj=0, y_size=12) +
    scale_x_continuous(labels=unit_format(unit = "%"))
    ggsave("results/figures/09-Genus_composition_by_instrain_mapping_proportion_corrected.pdf")
ggplotly(plot_genus_perc_corrected)
saveWidget(
                widget = ggplotly(plot_genus_perc_corrected),
                file = "results/figures/09-Genus_composition_by_instrain_mapping_proportion_corrected.html",
                selfcontained = TRUE #creates a single html file
          )
```
...
pdf("results/figures/09-presence_absence_heatmap.pdf")
...
draw(heatmap_obj, merge_legend = TRUE)
dev.off()
pdf("results/figures/09-coverage_heatmap_by_location.pdf")
...
pdf("results/figures/09-relative_coverage_heatmap.pdf")
...
draw(heatmap_obj, merge_legend = TRUE)
dev.off()
pdf("results/figures/09-relative_coverage_heatmap_by_location.pdf")
...
pdf("results/figures/09-relative_coverage_heatmap_IN_MY.pdf")
...
draw(heatmap_obj, merge_legend = TRUE)
dev.off()
pdf("results/figures/09-relative_coverage_heatmap_by_location_IN_MY.pdf")
...
pdf("results/figures/09-relative_coverage_heatmap_MY.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Lactobacillus.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Bombilactobacillus.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Bifidobacterium.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Gilliamella.pdf")
ggplot(df_reads %>%
        select(Sample, MAGs_DB, Trimmed) %>%
        mutate(Host = Vectorize(get_host_from_sample_name)(Sample)) %>%
        mutate(Location = Vectorize(get_location_from_sample_name)(Sample)) %>%
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Snodgrassella.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Apibacter.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_size(labels=unit_format(unit = "M", scale = 1e-6)) +
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Frischella.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Dysgonomonas.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Commensalibacter.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Pectinatus.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Bartonella.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__Bombella.pdf")
    ...
    geom_hline(yintercept = 10, linetype = "dotted") +
      make_theme(guide_nrow = 3, palettecolor = "Set1",
        ...
        # scale_color_manual(values=host_order_color_dark) +
          ...
          scale_x_continuous(labels=unit_format(unit = "M", scale = 1e-6))
          scale_size(labels=unit_format(unit = "M", scale = 1e-6))
          ggsave("results/figures/09-Coverage_vs_mapped_reads_g__WRHT01.pdf")
...
df_magOTUs_vegan_IN_MY <- abundance_df_matrix_pa %>%
                      filter(rowSums(.) > 0) %>%
                      filter()
dist_matrix_betapart <- beta.pair(df_magOTUs_vegan_IN_MY, "sorenson")
...
mag_tree_sub <- phy_tree(subset_taxa(ps, Genus %in% c("g__Dysgonomonas")))
# mag_tree_sub <- phy_tree(subset_taxa(ps, Genus %in% genera))
mag_tree_sub$tip.label <- lapply(mag_tree_sub$tip.label, rename_mag_labels)
associations_df <- abundance_df %>%
                left_join(cluster_tax_info %>% select(cluster_name, Cluster) %>% filter(!is.na(cluster_name))) %>%
                  left_join(vis_magOTUs_df_all %>% ungroup() %>% select(representative_genome, Cluster)) %>%
                  select(Cov, representative_genome, Sample) %>% 
                  mutate(Host = Vectorize(get_host_from_sample_name)(Sample)) %>%
                    filter(Cov > 20) %>%
                    select(!c(Cov, Sample)) %>%
                    unique() %>%
                    mutate(Host = Vectorize(reformat_host_name)(Host)) %>%
                    mutate(representative_genome = Vectorize(rename_mag_labels)(representative_genome)) %>%
                    filter(representative_genome %in% mag_tree_sub$tip.label)
associations <- cbind(associations_df$representative_genome, associations_df$Host)
cols <- unlist(lapply(as.character(associations_df$Host), function(x) host_order_color_dark[[paste0(strsplit(x, "_")[[1]], collapse = " ")]]))
# cols <- unlist(lapply(as.character(associations_df$representative_genome), function(x) genusColors_char[strsplit(x, "---")[[1]]][[1]]))
cophyloplot(mag_tree_sub, collapse.singles(host_tree), assoc = associations, space = 100, gap = 15, col = cols, lwd = 4, show.tip.label = F)
