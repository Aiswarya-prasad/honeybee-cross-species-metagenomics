...
Heatmap(t(abundance_df_matrix_Cov),
        col = colorRamp2(c(0, 100, 1000, 10000), colors = c("#ffffff", "#1a88c9", "#08519c", "#08306b")),
        # col = colorRamp2(c(0, 10, 100), colors = c(brewer.pal(9, "BrBG")[9], brewer.pal(9, "BrBG")[5], brewer.pal(9, "BrBG")[1])),
        clustering_method_columns = 'ward.D2',
          cluster_rows = T)
...
pdf("Figures/16-rarecurve.pdf")
rarec(data_otu, step = 20, sample = raremax, cols = colors_list, cex = 0.3)
dev.off()
