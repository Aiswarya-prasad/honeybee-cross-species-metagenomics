...
grid.arrange(
  ...
  ggsave("Figures/12f_heatmap_coverage_clustering.pdf")

grid.arrange(
    arrangeGrob(
      grid.rect(gp=gpar(col="white")),
      # plot(magOTU_clustering_pa %>% color_branches(k = 5) %>% rotate(samples)),
  ...
  ggsave("Figures/12f_heatmap_presence_absence_clustering.pdf")
